...
nadya = LINETCR.LINE()
#nadya.login(qr=true)
nadya.login(token='EsZqWTFe5kVqN7TrYYw8.7CqVAijxpLe9xyr5BO5fsa.3Q7gYnIa9NAS0WJV8MMrRL1W7J0TuPsp+BVcDvdiK30=')
nadya.loginResult()
...
*☆*▬▬▬▬▬▬▬▬▬*☆*
"""
tjia="uedc42f6882573e513d5d84796e8e4548"
...
Bots=[mid]
Creator=["uedc42f6882573e513d5d84796e8e4548"]
admin=["uedc42f6882573e513d5d84796e8e4548"]
...
wait = {
    ...
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nJangan Lupa Call Ya Kak hehehe",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
...
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 1:
                                        nadya.sendText(op.param1, "Ƈιє Ƈιє " + "☣ " + Name + " ☣" + "\nᴺᵍᶤᶰᵗᶤᵖ ᴬʲᵃ ᶳᶤᶤʰˑ ˑ ˑ\nᴬʷᵃᶳ ᴮᶤᶰᵗᶤᵗᵃᶰ   ")
                                        time.sleep(0.1)
                                    ...
                                    nadya.sendText(op.param1, "Ƈιє Ƈιє" + "\n☣ " + Name + " ☣" + "\nᴺᵍᵃᵖᵃᶤᶰ ᴺᵍᶤᶰᵗᶤᵖ ᴬʲᵃ???\nᶳᶤᶰᶤ ᴳᵃᵇᵘᶰᵍ ᶜʰᵃᵗ...\nᶳᶤᵃᵖᵃ ᵗᵃᵘ ᴰᵃᵖᵉᵗ ᵀᶤᵏᵘᶰᵍᵃᶰ   ")
                                    time.sleep(0.1)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            nadya.sendText(op.param1,"╔══════════════\n╠➳ 🍌 ᵂᵉˡᶜᵒᵐᵉ ᴷᵃᵏ " + nadya.getContact(op.param2).displayName + "\n╠➳ 🍌 ᶳᵉˡᵃᵐᵃᵗ ᴮᵉʳᵍᵃᵇᵘᶰᵍ ᴰᶤ ᴷᵉˡᵘᵃʳᵍᵃ:\n╠➳ 🍌 💫 " + str(ginfo.name) + " 💫" + "\n╠══════════════\n╠➳ 🍌 ᴼʷᶰᵉʳ ᴳʳᵘᵖ " + str(ginfo.name) + " :\n╠➳ 🍌 " + ginfo.creator.displayName + "\n╚══════════════") 
            nadya.sendText(op.param1,"╔═════════════════\n╠➳ 🍌 ᶳᶤˡᵃʰᵏᵃᶰ ᶜᵉᵏ ᴺᵒᵗᵉ😁😁\n╠➳ 🍌 ᶳᶤˡᵃʰᵏᵃᶰ ᴾᶤˡᶤʰ ᵀᵃʳᵍᵉᵗ ᵀᶤᵏᵘᶰᵍᵃᶰ😁😁\n╠➳ 🍌 ᴰᶤˡᵃʳᵃᶰᵍ ᴷᵉʳᵃᶳ ᴮᵃᵖᵉʳ😁😁😁😁\n╠➳ 🍌 ᶳᵃˡᵃᵐ ᴷᵉᶰᵃˡ ᴷᵃᵏᵃᵏ 😘😘😘\n╠➳ 🍌 Jɴɢɴ Lυpα Mтιĸɴ Noтιғ Groυp\n╠➳ 🍌 Aɢr Tdĸ Meɴɢɢαɴɢɢυ Aĸтιғιтαѕ\n╚═════════════════")
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"╔══════════════\n╠➳ 💊 "+ nadya.getContact(op.param2).displayName +  "\n╠══════════════\n╠➳ 💊 Kenapa Keluar Kak?\n╠➳ 💊 Baper Ya?\n╠➳ 💊 Ywdh Nnti Balik Lg y?\n╠➳ 💊 Biar Dapet Baperan Baru\n╚══════════════")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "25794790",
                                    "STKPKGID": "10215",
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["ᴬᵈᵃ ᵃᵖᵃ ᵏᵃᵏᵃᵏ" + cName + ",\nᴷᵉᶳᵉᵖᶤᵃᶰ ᵞᵃ?\nᶳᶤᶰᶤ ᴾᵐ ᴬʲᵃ ᴸᵃᶰᵍᶳᵘᶰᵍ ᵍᵃᵏ ᵘᶳᵃʰ ᵐᵃˡᵘ","кαиgєи αρα кαк? " + cName + " ngeтag мυlυ?\nᶳᶤᶰᶤ ᴾᵐ ᴬʲᵃ ᴸᵃᶰᵍᶳᵘᶰᵍ ᵍᵃᵏ ᵘᶳᵃʰ ᵐᵃˡᵘ ","ᴬᵈᵃ ᵃᵖᵃ ᴷᵃᵏ " + cName + " \nᴶᵃᶰᵍᵃᶰ ᵀᵃᵍ ᴮᵃᵉ ᴾᵐ ᴬʲᵃ ᴸᵃᶰᵍᶳᵘᶰᵍ"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention3"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["ᴬᵈᵃ ᵃᵖᵃ ᵏᵃᵏᵃᵏ" + cName + ",ᴷᵉᶳᵉᵖᶤᵃᶰ ᵞᵃ?"]
                    balas1 = "ᶳᶤᶰᶤ ᴾᵐ ᴬʲᵃ ᴸᵃᶰᵍᶳᵘᶰᵍ ᵍᵃᵏ ᵘᶳᵃʰ ᵐᵃˡᵘ"
                    ret_ = random.choice(balas)
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                nadya.sendText(msg.to,"Jones Betah Ni Jadi CCTV")
                
            elif "Jones off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    nadya.sendText(msg.to, "Para Jones Udah Kumpul")
                else:
                ...
                md = ""
		if wait["Sambutan"] == True: md+="╠➩🔒️ Sambutan : 🔒️ \n"
		else:md+="╠➩❌ Sambutan : 🔓\n"
		if wait["AutoJoin"] == True: md+="╠➩🔓 Auto Join : 🔒️ \n"
                else: md +="╠➩❌ Auto Join : 🔓\n"
		if wait["AutoJoinCancel"] == True: md+="╠➩🔒️ Auto Join Cancel : 🔒️ \n"
                else: md +="╠➩❌ Auto Join Cancel : 🔓\n"                
		if wait["Contact"] == True: md+="╠➩🔓️ Info Contact : 🔒️ \n"
		else: md+="╠➩❌ Info Contact : 🔓\n"
                if wait["AutoCancel"] == True:md+="╠➩🔒️ Auto Cancel : 🔒️ \n"
                else: md+= "╠➩❌ Auto Cancel : 🔓\n"
                if wait["inviteprotect"] == True:md+="╠➩🔒️ Invite Protect : 🔒️ \n"
                else: md+= "╠➩❌ Invite Protect : 🔓\n"                
		if wait["Qr"] == True: md+="╠➩🔒️ Qr Protect : 🔒️ \n"
		else:md+="╠➩❌ Qr Protect : 🔓\n"
		if wait["AutoKick"] == True: md+="╠➩🔒️ Auto Kick : 🔒️ \n"
		else:md+="╠➩❌ Auto Kick : 🔓\n"
		if wait["alwaysRead"] == True: md+="╠➩🔒️ Always Read : 🔒️ \n"
		else:md+="╠➩❌ Always Read: 🔓\n"
		if wait["detectMention"] == True: md+="╠➩🔒️ Auto Respon1 : 🔒️ \n"
		else:md+="╠➩❌ Auto Respon1 : 🔓\n"		
		if wait["detectMention2"] == True: md+="╠➩🔒️ Auto Respon2 : 🔒️ \n"
		else:md+="╠➩❌ Auto Respon2 : 🔓\n"	
		if wait["detectMention3"] == True: md+="╠➩🔒️ Auto Respon3 : 🔒️ \n"
		else:md+="╠➩❌ Auto Respon3 : 🔓\n"			
		if wait["kickMention"] == True: md+="╠➩🔒️ Auto Respon Kick : 🔒️ \n"
		else:md+="╠➩❌ Auto Respon Kick : 🔓\n"				
		if wait["Sider"] == True: md+="╠➩🔒️ Auto Sider : 🔒️ \n"
		else:md+="╠➩❌ Auto Sider: 🔓\n"	
		if wait["Simi"] == True: md+="╠➩🔒️ Simisimi : 🔒️ \n"
		else:md+="╠➩❌ Simisimi: 🔓\n"		
                ...
                msg.contentMetadata={'STKID': '18687390',
                                    'STKPKGID': '╠ Sticker Packages ID : 1520987',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '16267528',
                                    'STKPKGID': '1425309',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '20814007',
                                    'STKPKGID': '1620524',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '13479829',
                                    'STKPKGID': '7334',
                                    'STKVER': '2'}
                msg.text = None
                nadya.sendMessage(msg)
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "uedc42f6882573e513d5d84796e8e4548"
                nadya.inviteIntoGroup(msg.to,[midd])
		...
		nadya.sendText(msg.to, "Sabar Bos.....")
		...
		if msg.from_ in Creator:
                ...
                nadya.sendMessage(msg)
            ...
            elif "Dual @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Dual @","")
                   _nametarget = _name.rstrip('  ')
                   gs = nadya.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               nadya.CloneContactProfile(target)
                               nadya.sendText(msg.to, "Nah Jadi Dua Kan (^_^)")
                            except Exception as e:
                                print e
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = [" http://dl.profile.line-cdn.net/0hxKGDX37qJ2R6PQuTl8ZYM0Z4KQkNEyEsAg9oVlo4LlRVWDQ0El5vV189fgcCCmZmElxvClhueFZe"]
